...
def test_self():
    ...
    assert verify("triangle", info, info, 1)
...
def test_variant():
    ...
    assert verify("quadrilateral", info0, info1, 1)
...
def test_hermite_vs_lagrange():
    ...
    assert not verify("triangle", info0, info1, 3)
...
def test_verify_bdm_vs_n2():
    ...
    assert not verify("triangle", info0, info1, 2)
